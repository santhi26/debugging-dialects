...
export default function HomePage() {
    return (
        <>
            ...
            <section class="nh-section-inset privacysection wf-section">
                <div class="w-layout-blockcontainer nh-wrap sectionverticalpadding w-container">
                    <div class="nh-section-inner-grid">
                        ...
                        <div id="w-node-c33cdf7c-471d-fd55-889b-d2d9e498b2af-db6ab9e5" class="nh-section-grid-item">
                            <div class="nh-inner-feature-icon-list">
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-e329728d-5cc3-161b-56e3-a49e1d9d46f0-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc">Private, in-person tutors are pricey. We let you get taught for a fraction of the cost. Plans start at just $1/mo.</div>
                                    </div>
                                </div>
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-a4309e21-65da-e3da-ec7d-f8db0be004ff-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc">We have over 10,000 teachers on our platform. So there's always a great tutor online and ready to teach you.</div>
                                    </div>
                                </div>
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-_5d474926-7521-2699-6bbc-1457dc8bc2d9-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc">We use state-of-art AI to create flashcards for you. Our algorithm will then show you it again at <em>just</em> the right time. So you never forget.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="nh-section-inset benefitssection wf-section">
                <div class="w-layout-blockcontainer nh-wrap sectionverticalpadding w-container">
                    <div class="nh-section-inner-grid">
                        ...
                        <div id="w-node-df542443-be75-0808-bfbb-7b19d9b0331c-db6ab9e5" class="nh-section-grid-item">
                            <div class="nh-inner-feature-icon-list">
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-df542443-be75-0808-bfbb-7b19d9b03320-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc benefits-feature-item-desc">No time commitment. Just log in and get teaching whenever.</div>
                                    </div>
                                </div>
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-df542443-be75-0808-bfbb-7b19d9b03327-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc benefits-feature-item-desc">All you need is an internet connection and a computer and you can start earning.</div>
                                    </div>
                                </div>
                                <div class="nh-inner-feature-icon-item">
                                    ...
                                    <div id="w-node-df542443-be75-0808-bfbb-7b19d9b0332e-db6ab9e5" class="nh-inner-feature-details">
                                        ...
                                        <div class="nh-inner-feature-item-desc benefits-feature-item-desc">Our pay-as-you-go model means you start earning right away and we pay you at the end of each day.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-layout-blockcontainer nh-wrap sectionverticalpadding w-container">
                    ...
                    <div class="nh-bottom-testimonials-wrap">
                        <div id="w-node-_5ba1ead9-6220-f643-f969-356542c0e98d-db6ab9e5" class="nh-bottom-testimonial">
                            <div class="nh-bottom-testimonial-qblock">
                                <div class="quincypullquote">“</div>
                                <div class="bottom-testimonial-title">I love the mix of personal and remote. Great pricing.</div>
                                <div class="bottom-testimonial-desc">English teachers are so expensive and beyond my reach. FluentPal means I can get lessons from one at a really good price.</div>
                            </div>
                            <div class="bottom-testimonial-author"><img src="https://ca.slack-edge.com/THYP60S66-U0575J0PPNC-b7267f40edb6-512" loading="lazy" width="60" height="60" id="w-node-_36ab8e4a-fc22-fc58-d825-3094ca5343be-db6ab9e5" alt="" class="bottom-testimonial-avatar" />
                                <div id="w-node-a6aa590a-62d3-fbd7-9e2a-af5ce31c012a-db6ab9e5" class="bottom-testimonial-name-wrap">
                                    <div id="w-node-dde39aad-d2c0-ef3a-7496-ef6b601ec0a6-db6ab9e5" class="bottom-testimonial-name">Lexis</div>
                                    <div class="bottom-testimonial-company">Student</div>
                                </div>
                            </div>
                        </div>
                        <div id="w-node-_7967b907-68a6-8957-a9fa-64dac5d63517-db6ab9e5" class="nh-bottom-testimonial">
                            <div class="nh-bottom-testimonial-qblock">
                                <div class="bottom-testimonial-title">Rewarding. An easy way to supplement your income.</div>
                                <div class="bottom-testimonial-desc">I'm actually a Geography teacher by day. But as long as you can speak English you can use FluetPal to teach students. I like teaching and helping and I love the flexiblity of the site.</div>
                                <div class="quincypullquote">“</div>
                            </div>
                            <div class="bottom-testimonial-author"><img src="https://ca.slack-edge.com/THYP60S66-U055WBG38JG-38f19a6ad23b-512" loading="lazy" width="60" height="60" id="w-node-_1b4ac9d8-670f-4a86-468b-867f8bd9b511-db6ab9e5" alt="" class="bottom-testimonial-avatar" />
                                <div id="w-node-_1b4ac9d8-670f-4a86-468b-867f8bd9b512-db6ab9e5" class="bottom-testimonial-name-wrap">
                                    <div id="w-node-_1b4ac9d8-670f-4a86-468b-867f8bd9b513-db6ab9e5" class="bottom-testimonial-name">Sophie</div>
                                    <div class="bottom-testimonial-company">Teacher</div>
                                </div>
                            </div>
                        </div>
                    </div>
