...
export default function TeacherProfileForm() {
    ...
    const teacherProfileAPI = async() => {
        try {
            ...
            const response = await fetch(`https://backend-dialects.onrender.com/api/teacher/${userID}/update`, options);
            await response.json();  
    ...
    const searchTeacherAPI = async() => {
        try {
            const response = await fetch(`https://backend-dialects.onrender.com/api/teacher/${userID}/details`);
